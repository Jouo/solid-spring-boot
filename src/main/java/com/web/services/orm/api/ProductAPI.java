...
public class ProductAPI {
    ...
    private StockAPI stock = new StockAPI();

    public ProductAPI() {}

    public ProductAPI(String name, Float cost, Float price, String image, Long category, StockAPI stock) {
        this.name = name;
        this.cost = cost;
        this.price = price;
        this.image = image;
    ...
    public String toString() {
        Formatter formatter = new ValueFormatter()
                ...
                .add("image", image).add("category", category).add("stock", stock.logString());
    ...
    public void setStock(StockAPI stock) {
        this.stock = stock;
    }
}
